/**
 *
 * @defgroup PERSONALITY_PIN Pin Personality
 * @ingroup PERSONALITIES
 * @{
 * The pins of the Pin personality for PSOC C1 family microcontrollers do not generate service requests. This feature is determined by the hardware architecture of the PSOC C1 family.<br>
