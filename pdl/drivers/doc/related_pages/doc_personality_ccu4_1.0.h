/**
 *
 * @defgroup PERSONALITY_CCU4 CCU4 Personality
 ...
 *
 * CCU4 1.0 is left in PSC1M3 PDL for the backward compatibility with already created projects not to be updated by the user.
 *
 * The CCU4 1.0 support will be removed in the next major PDL revision.
 *
