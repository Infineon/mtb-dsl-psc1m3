 ...
 * -# Provides a structure type Cy_USIC_CH_t to represent the USIC channel registers in a programmer
 friendly format.
 * -# Allows configuration of automatic update for frame length, word length, slave select or slave address.
 * -# Allows transmission of data to FIFO using Cy_USIC_CH_TXFIFO_PutData() and Cy_USIC_CH_TXFIFO_PutDataFLEMode()
 * -# Allows reading of received data in FIFO using Cy_USIC_CH_RXFIFO_GetData()
 * -# Allows configuration of baudrate using Cy_USIC_CH_SetBaudrate()
 * -# Provides API to trigger interrupts using Cy_USIC_CH_TriggerServiceRequest()
 * @{
 */
...
#define CY_USIC0 ((Cy_USIC_t *)USIC0_BASE)			/**< USIC0 module base address */
#define CY_USIC0_CH0 ((Cy_USIC_CH_t *)USIC0_CH0_BASE)	/**< USIC0 channel 0 base address */
#define CY_USIC0_CH1 ((Cy_USIC_CH_t *)USIC0_CH1_BASE)	/**< USIC0 channel 1 base address */

#if defined(USIC1)
#define CY_USIC1 ((Cy_USIC_t *)USIC1_BASE)			/**< USIC1 module base address */
#define CY_USIC1_CH0 ((Cy_USIC_CH_t *)USIC1_CH0_BASE)	/**< USIC1 channel 0 base address */
#define CY_USIC1_CH1 ((Cy_USIC_CH_t *)USIC1_CH1_BASE)	/**< USIC1 channel 1 base address */
#endif

#if defined(USIC2)
#define CY_USIC2 ((Cy_USIC_t *)USIC2_BASE)			/**< USIC2 module base address */
#define CY_USIC2_CH0 ((Cy_USIC_CH_t *)USIC2_CH0_BASE)	/**< USIC2 channel 0 base address */
#define CY_USIC2_CH1 ((Cy_USIC_CH_t *)USIC2_CH1_BASE)	/**< USIC2 channel 1 base address */
#endif
 ...
 */
typedef enum CY_USIC_CH_STATUS
{
  CY_USIC_CH_STATUS_OK,    /**< USIC driver status : OK */
  CY_USIC_CH_STATUS_ERROR, /**< USIC driver status : ERROR */
  CY_USIC_CH_STATUS_BUSY   /**< USIC driver status : BUSY */
} Cy_USIC_CH_STATUS_t;

/**
* USIC channel kernel mode
*/
typedef enum CY_USIC_CH_KERNEL_MODE
{
  CY_USIC_CH_KERNEL_MODE_RUN_0  = 0x0UL,  /**< Run mode 0 (transmission and reception possible)*/
  CY_USIC_CH_KERNEL_MODE_RUN_1  = 0x1UL << USIC_CH_KSCFG_NOMCFG_Pos,  /**< Run mode 1 (transmission and reception possible)*/
  CY_USIC_CH_KERNEL_MODE_STOP_0 = 0x2UL << USIC_CH_KSCFG_NOMCFG_Pos,  /**< Stop mode 0 (no transmission, but reception possible)*/
  CY_USIC_CH_KERNEL_MODE_STOP_1 = 0x3UL << USIC_CH_KSCFG_NOMCFG_Pos   /**< Stop mode 1 (both transmission and reception not possible)*/
} Cy_USIC_CH_KERNEL_MODE_t;

/**
 * USIC channel operating mode
 */
typedef enum CY_USIC_CH_OPERATING_MODE
{
  CY_USIC_CH_OPERATING_MODE_IDLE = 0x0UL, /**< USIC channel idle */
  CY_USIC_CH_OPERATING_MODE_SPI  = 0x1UL << USIC_CH_CCR_MODE_Pos, /**< SPI mode */
  CY_USIC_CH_OPERATING_MODE_UART = 0x2UL << USIC_CH_CCR_MODE_Pos, /**< UART mode */
  CY_USIC_CH_OPERATING_MODE_I2S  = 0x3UL << USIC_CH_CCR_MODE_Pos, /**< I2S mode */
  CY_USIC_CH_OPERATING_MODE_I2C  = 0x4UL << USIC_CH_CCR_MODE_Pos  /**< I2C mode */
} Cy_USIC_CH_OPERATING_MODE_t;

/**
 * USIC channel inputs
 */
typedef enum CY_USIC_CH_INPUT
{
  CY_USIC_CH_INPUT_DX0, /**< DX0 input */
  CY_USIC_CH_INPUT_DX1, /**< DX1 input */
  CY_USIC_CH_INPUT_DX2, /**< DX2 input */
  CY_USIC_CH_INPUT_DX3, /**< DX3 input */
  CY_USIC_CH_INPUT_DX4, /**< DX4 input */
  CY_USIC_CH_INPUT_DX5  /**< DX5 input */
} Cy_USIC_CH_INPUT_t;

/**
 * USIC channel input source sampling frequency
 */
typedef enum CY_USIC_CH_INPUT_SAMPLING_FREQ
{
  CY_USIC_CH_INPUT_SAMPLING_FREQ_FPERIPH            = 0x0UL, /**< Use fperiph frequency for input source sampling*/
  CY_USIC_CH_INPUT_SAMPLING_FREQ_FRACTIONAL_DIVIDER = 0x1UL << USIC_CH_DXCR_SFSEL_Pos  /**< Use fFD(fractional divider) frequency for input source sampling*/
} Cy_USIC_CH_INPUT_SAMPLING_FREQ_t;

/**
 * USIC channel input combination mode
 */
typedef enum CY_USIC_CH_INPUT_COMBINATION_MODE
{
  CY_USIC_CH_INPUT_COMBINATION_MODE_TRIGGER_DISABLED = 0x0UL, /**< The trigger activation is disabled.*/
  CY_USIC_CH_INPUT_COMBINATION_MODE_RISING_EDGE      = 0x1UL, /**< A rising edge activates DXnT*/
  CY_USIC_CH_INPUT_COMBINATION_MODE_FALLING_EDGE     = 0x2UL, /**< A falling edge activates DXnT*/
  CY_USIC_CH_INPUT_COMBINATION_MODE_BOTH_EDGES       = 0x3UL, /**< Both edges activate DXnT*/
} Cy_USIC_CH_INPUT_COMBINATION_MODE_t;
 ...
 */
typedef enum CY_USIC_CH_START_TRANSMISION_MODE
{
  CY_USIC_CH_START_TRANSMISION_DISABLED      = 0x0U, /**< Passive data level is sent out on transmission. */
  CY_USIC_CH_START_TRANSMISION_ON_TDV        = 0x1UL << USIC_CH_TCSR_TDEN_Pos, /**< Transmission of the data word in TBUF can be started if TDV = 1 */
  CY_USIC_CH_START_TRANSMISION_ON_TDV_DX2S_0 = 0x2UL << USIC_CH_TCSR_TDEN_Pos, /**< Transmission of the data word in TBUF can be started if TDV = 1 while DX2S_0 */
  CY_USIC_CH_START_TRANSMISION_ON_TDV_DX2S_1 = 0x3UL << USIC_CH_TCSR_TDEN_Pos  /**< Transmission of the data word in TBUF can be started if TDV = 1 while DX2S_1 */
} Cy_USIC_CH_START_TRANSMISION_MODE_t;

/**
 * USIC channel interrupt node pointers
 */
typedef enum CY_USIC_CH_INTERRUPT_NODE_POINTER
{
  CY_USIC_CH_INTERRUPT_NODE_POINTER_TRANSMIT_SHIFT      = USIC_CH_INPR_TSINP_Pos, /**< Node pointer for transmit shift interrupt */
  CY_USIC_CH_INTERRUPT_NODE_POINTER_TRANSMIT_BUFFER     = USIC_CH_INPR_TBINP_Pos, /**< Node pointer for transmit buffer interrupt */
  CY_USIC_CH_INTERRUPT_NODE_POINTER_RECEIVE             = USIC_CH_INPR_RINP_Pos,  /**< Node pointer for receive interrupt */
  CY_USIC_CH_INTERRUPT_NODE_POINTER_ALTERNATE_RECEIVE   = USIC_CH_INPR_AINP_Pos,  /**< Node pointer for alternate receive interrupt */
  CY_USIC_CH_INTERRUPT_NODE_POINTER_PROTOCOL            = USIC_CH_INPR_PINP_Pos   /**< Node pointer for protocol related interrupts */
} Cy_USIC_CH_INTERRUPT_NODE_POINTER_t;

/**
 * USIC channel events
 */
typedef enum CY_USIC_CH_EVENT
{
  CY_USIC_CH_EVENT_RECEIVE_START       = USIC_CH_CCR_RSIEN_Msk, /**< Receive start event */
  CY_USIC_CH_EVENT_DATA_LOST           = USIC_CH_CCR_DLIEN_Msk, /**< Data lost event */
  CY_USIC_CH_EVENT_TRANSMIT_SHIFT      = USIC_CH_CCR_TSIEN_Msk, /**< Transmit shift event */
  CY_USIC_CH_EVENT_TRANSMIT_BUFFER     = USIC_CH_CCR_TBIEN_Msk, /**< Transmit buffer event */
  CY_USIC_CH_EVENT_STANDARD_RECEIVE    = USIC_CH_CCR_RIEN_Msk,  /**< Receive event */
  CY_USIC_CH_EVENT_ALTERNATIVE_RECEIVE = USIC_CH_CCR_AIEN_Msk,  /**< Alternate receive event */
  CY_USIC_CH_EVENT_BAUD_RATE_GENERATOR = USIC_CH_CCR_BRGIEN_Msk /**< Baudrate generator event */
} Cy_USIC_CH_EVENT_t;

/**
* USIC channel parity mode
*/
typedef enum CY_USIC_CH_PARITY_MODE
{
  CY_USIC_CH_PARITY_MODE_NONE     = 0x0UL,  /**< Disable parity mode */
  CY_USIC_CH_PARITY_MODE_EVEN     = 0x2UL << USIC_CH_CCR_PM_Pos,  /**< Enable even parity mode */
  CY_USIC_CH_PARITY_MODE_ODD      = 0x3UL << USIC_CH_CCR_PM_Pos   /**< Enable odd parity mode */
} Cy_USIC_CH_PARITY_MODE_t;

/**
* USIC channel data output mode
*/
typedef enum CY_USIC_CH_DATA_OUTPUT_MODE
{
  CY_USIC_CH_DATA_OUTPUT_MODE_NORMAL   = 0x0UL,  /**< Data output normal mode */
  CY_USIC_CH_DATA_OUTPUT_MODE_INVERTED = 0x1UL << USIC_CH_SCTR_DOCFG_Pos   /**< Data output inverted mode */
} Cy_USIC_CH_DATA_OUTPUT_MODE_t;

/**
* USIC channel data transmit buffer status
*/
typedef enum CY_USIC_CH_TBUF_STATUS
{
  CY_USIC_CH_TBUF_STATUS_IDLE = 0x0UL,                 /**< Transfer buffer is currently idle*/
  CY_USIC_CH_TBUF_STATUS_BUSY = USIC_CH_TCSR_TDV_Msk   /**< Transfer buffer is currently busy*/
} Cy_USIC_CH_TBUF_STATUS_t;
...
*/
typedef enum CY_USIC_CH_TBUF_STATUS_SET
{
  CY_USIC_CH_TBUF_STATUS_SET_BUSY   = 0x1UL, /**< Set Transfer buffer status to busy*/
  CY_USIC_CH_TBUF_STATUS_SET_IDLE   = 0x2UL  /**< Set Transfer buffer status to idle*/
} Cy_USIC_CH_TBUF_STATUS_SET_t;

/**
* USIC channel receive buffer status
*/
typedef enum CY_USIC_CH_RBUF_STATUS
{
  CY_USIC_CH_RBUF_STATUS_DATA_VALID0 = USIC_CH_RBUFSR_RDV0_Msk, /**< RBUF0 data has not yet been read out*/
  CY_USIC_CH_RBUF_STATUS_DATA_VALID1 = USIC_CH_RBUFSR_RDV1_Msk  /**< RBUF1 data has not yet been read out*/
} Cy_USIC_CH_RBUF_STATUS_t;

/**
 * USIC channel output signal passive data level
*/
typedef enum CY_USCI_CH_PASSIVE_DATA_LEVEL
{
  CY_USIC_CH_PASSIVE_DATA_LEVEL0 = 0x0UL, /**< Passive level(idle mode signal level) 0 */
  CY_USIC_CH_PASSIVE_DATA_LEVEL1 = 0x1UL << USIC_CH_SCTR_PDL_Pos  /**< Passive level(idle mode signal level) 1 */
} Cy_USIC_CH_PASSIVE_DATA_LEVEL_t;

/**
* USIC channel receive FIFO size
*/
typedef enum CY_USIC_CH_FIFO_SIZE
{
  CY_USIC_CH_FIFO_DISABLED     = 0x0U,  /**< FIFO Disabled */
  CY_USIC_CH_FIFO_SIZE_2WORDS  = 0x1U,  /**< FIFO size: 2 words */
  CY_USIC_CH_FIFO_SIZE_4WORDS  = 0x2U,  /**< FIFO size: 4 words */
  CY_USIC_CH_FIFO_SIZE_8WORDS  = 0x3U,  /**< FIFO size: 8 words */
  CY_USIC_CH_FIFO_SIZE_16WORDS = 0x4U,  /**< FIFO size: 16 words */
  CY_USIC_CH_FIFO_SIZE_32WORDS = 0x5U,  /**< FIFO size: 32 words */
  CY_USIC_CH_FIFO_SIZE_64WORDS = 0x6U   /**< FIFO size: 64 words */
} Cy_USIC_CH_FIFO_SIZE_t;

/**
* USIC channel transmit FIFO interrupt node pointers
*/
typedef enum CY_USIC_CH_TXFIFO_INTERRUPT_NODE_POINTER
{
  CY_USIC_CH_TXFIFO_INTERRUPT_NODE_POINTER_STANDARD  = USIC_CH_TBCTR_STBINP_Pos,  /**< Node pointer for FIFO standard transmit interrupt */
  CY_USIC_CH_TXFIFO_INTERRUPT_NODE_POINTER_ALTERNATE = USIC_CH_TBCTR_ATBINP_Pos   /**< Node pointer for transmit FIFO error interrupt */
} Cy_USIC_CH_TXFIFO_INTERRUPT_NODE_POINTER_t;

/**
* USIC channel transmit FIFO event configuration
*/
typedef enum CY_USIC_CH_TXFIFO_EVENT_CONF
{
  CY_USIC_CH_TXFIFO_EVENT_CONF_STANDARD  = USIC_CH_TBCTR_STBIEN_Msk,   /**< Enable FIFO standard transmit interrupt */
  CY_USIC_CH_TXFIFO_EVENT_CONF_ERROR     = (int32_t)USIC_CH_TBCTR_TBERIEN_Msk  /**< Enable transmit FIFO error interrupt */
} Cy_USIC_CH_TXFIFO_EVENT_CONF_t;

/**
* USIC channel transmit FIFO status
*/
typedef enum CY_USIC_CH_TXFIFO_EVENT
{
  CY_USIC_CH_TXFIFO_EVENT_STANDARD = USIC_CH_TRBSR_STBI_Msk,    /**< Transmit FIFO status: Standard event */
  CY_USIC_CH_TXFIFO_EVENT_ERROR    = USIC_CH_TRBSR_TBERI_Msk    /**< Transmit FIFO status: Error event */
} Cy_USIC_CH_TXFIFO_EVENT_t;

/**
* USIC channel receive FIFO interrupt node pointers
*/
typedef enum CY_USIC_CH_RXFIFO_INTERRUPT_NODE_POINTER
{
  CY_USIC_CH_RXFIFO_INTERRUPT_NODE_POINTER_STANDARD  = USIC_CH_RBCTR_SRBINP_Pos, /**< Node pointer for FIFO standard receive interrupt */
  CY_USIC_CH_RXFIFO_INTERRUPT_NODE_POINTER_ALTERNATE = USIC_CH_RBCTR_ARBINP_Pos  /**< Node pointer for FIFO alternative receive interrupt */
} Cy_USIC_CH_RXFIFO_INTERRUPT_NODE_POINTER_t;

/**
* USIC channel receive FIFO event configuration
*/
typedef enum CY_USIC_CH_RXFIFO_EVENT_CONF
{
  CY_USIC_CH_RXFIFO_EVENT_CONF_STANDARD  = USIC_CH_RBCTR_SRBIEN_Msk,   /**< Enable FIFO standard receive interrupt */
  CY_USIC_CH_RXFIFO_EVENT_CONF_ERROR     = (int32_t)USIC_CH_RBCTR_RBERIEN_Msk,  /**< Enable receive FIFO error interrupt */
  CY_USIC_CH_RXFIFO_EVENT_CONF_ALTERNATE = USIC_CH_RBCTR_ARBIEN_Msk   /**< Enable FIFO alternative receive interrupt */
} Cy_USIC_CH_RXFIFO_EVENT_CONF_t;

/**
* USIC channel receive FIFO status
*/
typedef enum CY_USIC_CH_RXFIFO_EVENT
{
  CY_USIC_CH_RXFIFO_EVENT_STANDARD  = USIC_CH_TRBSR_SRBI_Msk,   /**< Receive FIFO status: Standard event */
  CY_USIC_CH_RXFIFO_EVENT_ERROR     = USIC_CH_TRBSR_RBERI_Msk,  /**< Receive FIFO status: Error event */
  CY_USIC_CH_RXFIFO_EVENT_ALTERNATE = USIC_CH_TRBSR_ARBI_Msk    /**< Receive FIFO status: Alternative event */
} Cy_USIC_CH_RXFIFO_EVENT_t;

/**
* USIC channel baudrate generator clock source
*/
typedef enum CY_USIC_CH_BRG_CLOCK_SOURCE
{
  CY_USIC_CH_BRG_CLOCK_SOURCE_DIVIDER = 0x0UL, /**< Baudrate generator clock source : Source divider. (Internal clock source)*/
  CY_USIC_CH_BRG_CLOCK_SOURCE_DX1T    = 0x2UL << USIC_CH_BRG_CLKSEL_Pos,  /**< Baudrate generator clock source : DX1T. (External clock source) */
  CY_USIC_CH_BRG_CLOCK_SOURCE_DX1S    = 0x3UL << USIC_CH_BRG_CLKSEL_Pos  /**< Baudrate generator clock source : DX1S. (External clock source) */
} Cy_USIC_CH_BRG_CLOCK_SOURCE_t;

/**
* USIC channel input selection for CTQ
*/
typedef enum CY_USIC_CH_BRG_CTQSEL
{
  CY_USIC_CH_BRG_CTQSEL_PDIV = 0x0UL, /**< fCTQIN = fPDIV */
  CY_USIC_CH_BRG_CTQSEL_PPP  = 0x1UL << USIC_CH_BRG_CTQSEL_Pos,  /**< fCTQIN = fPPP */
  CY_USIC_CH_BRG_CTQSEL_SCLK = 0x2UL << USIC_CH_BRG_CTQSEL_Pos,  /**< fCTQIN = fSCLK */
  CY_USIC_CH_BRG_CTQSEL_MCLK = 0x3UL << USIC_CH_BRG_CTQSEL_Pos  /**< fCTQIN = fMCLK */
} Cy_USIC_CH_BRG_CTQSEL_t;


/**
* USIC channel baudrate generator divider mode
*/
typedef enum CY_USIC_CH_BRG_CLOCK_DIVIDER_MODE
{
  CY_USIC_CH_BRG_CLOCK_DIVIDER_MODE_DISABLED   = 0x0UL, /**< Baudrate generator clock divider: Disabled */
  CY_USIC_CH_BRG_CLOCK_DIVIDER_MODE_NORMAL     = 0x1UL << USIC_CH_FDR_DM_Pos, /**< Baudrate generator clock divider: Normal mode */
  CY_USIC_CH_BRG_CLOCK_DIVIDER_MODE_FRACTIONAL = 0x2UL << USIC_CH_FDR_DM_Pos  /**< Baudrate generator clock divider: Fractional mode */
} Cy_USIC_CH_BRG_CLOCK_DIVIDER_MODE_t;

/**
* USIC channel baudrate generator master clock passive level
*/
typedef enum CY_USIC_CH_BRG_MASTER_CLOCK_PASSIVE_LEVEL
{
  CY_USIC_CH_BRG_MASTER_CLOCK_PASSIVE_LEVEL_0 = 0x0UL, /**< Baudrate generator master clock passive level(idle mode signal level) 0*/
  CY_USIC_CH_BRG_MASTER_CLOCK_PASSIVE_LEVEL_1 = 0x1UL << USIC_CH_BRG_MCLKCFG_Pos  /**< Baudrate generator master clock passive level((idle mode signal level)) 1*/
} Cy_USIC_CH_BRG_MASTER_CLOCK_PASSIVE_LEVEL_t;

/**
* USIC channel baudrate generator shift clock passive level
*/
typedef enum CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL
{
  CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_0_DELAY_DISABLED = 0x0UL, /**< Shift clock passive level 0, delay disabled */
  CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_1_DELAY_DISABLED = 0x1UL << USIC_CH_BRG_SCLKCFG_Pos, /**< Shift clock passive level 1, delay disabled */
  CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_0_DELAY_ENABLED  = (int32_t)(0x2UL << USIC_CH_BRG_SCLKCFG_Pos), /**< Shift clock passive level 0, delay enabled */
  CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_1_DELAY_ENABLED  = (int32_t)(0x3UL << USIC_CH_BRG_SCLKCFG_Pos)  /**< Shift clock passive level 1, delay enabled */
} Cy_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_t;

/**
* USIC channel baudrate generator shift clock output
*/
typedef enum CY_USIC_CH_BRG_SHIFT_CLOCK_OUTPUT
{
  CY_USIC_CH_BRG_SHIFT_CLOCK_OUTPUT_SCLK = 0x0UL, /**< Baudrate generator shift clock output: SCL.(Internally generated shift clock)*/
  CY_USIC_CH_BRG_SHIFT_CLOCK_OUTPUT_DX1 = 0x1UL << USIC_CH_BRG_SCLKOSEL_Pos   /**< Baudrate generator shift clock output: DX1. (External input shift clock)*/
} Cy_USIC_CH_BRG_SHIFT_CLOCK_OUTPUT_t;

/**
* USIC channel shift direction.
* Defines the shift direction of the data words for transmission and reception
*/
typedef enum CY_USIC_CH_SHIFT_DIRECTION
{
  CY_USIC_CH_SHIFT_DIRECTION_LSB_FIRST = 0x0UL, /**< Shift LSB first. The first data bit of a data word is located at bit position 0. */
  CY_USIC_CH_SHIFT_DIRECTION_MSB_FIRST = 0x1UL << USIC_CH_SCTR_SDIR_Pos /**< Shift MSB first. The first data bit of a data word is located at the bit position given by the configured word length. */
} Cy_USIC_CH_SHIFT_DIRECTION_t;
 ...
 */
typedef USIC_GLOBAL_TypeDef Cy_USIC_t;
...
__STATIC_INLINE bool Cy_USIC_IsModuleValid(const Cy_USIC_t *const module)
{
  bool tmp;

  tmp = (module == CY_USIC0);
#if defined(CY_USIC1)
  tmp = tmp || (module == CY_USIC1);
#endif
#if defined(CY_USIC2)
  tmp = tmp || (module == CY_USIC2);
#endif

  return tmp;
}

__STATIC_INLINE bool Cy_USIC_IsChannelValid(const Cy_USIC_CH_t *const channel)
{
  bool tmp;

  tmp = ((channel == CY_USIC0_CH0) || (channel == CY_USIC0_CH1));
#if defined(CY_USIC1)
  tmp = tmp || ((channel == CY_USIC1_CH0) || (channel == CY_USIC1_CH1));
#endif
#if defined(CY_USIC2)
  tmp = tmp || ((channel == CY_USIC2_CH0) || (channel == CY_USIC2_CH1));
#endif
...
/**
 * @param  usic Pointer to USIC module handler of type @ref Cy_USIC_t.\n
 * 				\b Range: @ref CY_USIC0 to @ref CY_USIC2 based on device support.
 * @return None
 *
 ...
 * Cy_USIC_CH_Enable(), Cy_USIC_Disable() \n\n\n
 */
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_Disable(), Cy_USIC_Enable() \n\n\n
 */
void Cy_USIC_Disable(Cy_USIC_t *const usic);
/**
 * @param  channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetStartTransmisionMode(), Cy_USIC_CH_SetInputSource() \n\n\n
 */
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetFractionalDivider() \n\n\n
 */
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetBaudrateMode(), Cy_USIC_CH_SetBaudrate(), Cy_USIC_CH_SetBaudrateEx() \n\n\n
 */
 ...
 * @param  channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @param  input USIC channel input stage of type @ref Cy_USIC_CH_INPUT_t. \n
 * 				 \b Range: @ref CY_USIC_CH_INPUT_DX0 to @ref CY_USIC_CH_INPUT_DX5
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableInputInversion(), Cy_USIC_CH_EnableInputDigitalFilter(), Cy_USIC_CH_EnableInputSync(),
 * Cy_USIC_CH_SetInputSamplingFreq()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetInputSource(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input, const uint8_t source)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_ConnectInputDataShiftToDataInput()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_ConnectInputDataShiftToPPP(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
 ...
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_ConnectInputDataShiftToPPP()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_ConnectInputDataShiftToDataInput(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
 ...
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableInputInversion()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableInputInversion(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
 ...
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableInputInversion()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableInputInversion(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
 ...
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableDelayCompensation()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableDelayCompensation(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableDelayCompensation()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableDelayCompensation(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableInputDigitalFilter()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableInputDigitalFilter(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableInputDigitalFilter()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableInputDigitalFilter(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
  channel->DXCR[input] &= (uint32_t)~USIC_CH_DXCR_DFEN_Msk;
}
/**
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableInputSync(), Cy_USIC_CH_EnableInputDigitalFilter()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableInputSync(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableInputSync(), Cy_USIC_CH_DisableInputDigitalFilter() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableInputSync(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_INPUT_t input)
{
  channel->DXCR[input] &= (uint32_t)~USIC_CH_DXCR_DSEN_Msk;
}
/**
 ...
 * @param  input USIC channel input stage of type @ref Cy_USIC_CH_INPUT_t. \n
 * 				 \b Range: @ref CY_USIC_CH_INPUT_DX0 to @ref CY_USIC_CH_INPUT_DX5
 * @param  sampling_freq Sampling frequency value of type \a Cy_USIC_CH_INPUT_SAMPLING_FREQ_t.
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetInputSource(), Cy_USIC_CH_EnableInputSync(), Cy_USIC_CH_EnableInputDigitalFilter() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetInputSamplingFreq(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_INPUT_t input,
    const Cy_USIC_CH_INPUT_SAMPLING_FREQ_t sampling_freq)
{
 ...
 * @param  input USIC channel input stage of type @ref Cy_USIC_CH_INPUT_t. \n
 * 				 \b Range: @ref CY_USIC_CH_INPUT_DX0 to @ref CY_USIC_CH_INPUT_DX5
 * @param  combination_mode Combination mode value of type \a Cy_USIC_CH_INPUT_COMBINATION_MODE_t.
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 * Cy_USIC_CH_SetInputSource(), Cy_USIC_CH_EnableInputSync(), Cy_USIC_CH_EnableInputDigitalFilter() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetInputTriggerCombinationMode(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_INPUT_t input,
    const Cy_USIC_CH_INPUT_COMBINATION_MODE_t combination_mode)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetInputTriggerCombinationMode(), Cy_USIC_CH_SetExternalClockBRGDivider()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetBRGInputClockSource(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_BRG_CLOCK_SOURCE_t clock_source)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_WriteToTBUFTCI() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_WriteToTBUF(Cy_USIC_CH_t *const channel, const uint16_t data)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_WriteToTBUF() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_WriteToTBUFTCI(Cy_USIC_CH_t *const channel,
    const uint16_t data,
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetFrameLength()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetWordLength(Cy_USIC_CH_t *const channel, const uint8_t word_length)
{
 ...
 * Cy_USIC_CH_SetFrameLength()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetShiftDirection(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_SHIFT_DIRECTION_t shift_direction)
{
 ...
 */
__STATIC_INLINE uint32_t Cy_USIC_CH_GetCaptureTimerValue(const Cy_USIC_CH_t *const channel)
{
  return channel->CMTR;
}
 ...
 * @param  channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 *           \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @param  mode divider mode ::Cy_USIC_CH_BRG_CLOCK_DIVIDER_MODE_t \n
 * @param  step divider \n
 *             \b CY_USIC_CH_BRG_CLOCK_DIVIDER_MODE_NORMAL resulting divider = 1023 - step \n
 *             \b CY_USIC_CH_BRG_CLOCK_DIVIDER_MODE_FRACTIONAL resulting divider = 1023 / step \n
 *
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 *
 */
__STATIC_INLINE void Cy_USIC_CH_SetFractionalDivider(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_BRG_CLOCK_DIVIDER_MODE_t mode, const uint16_t step)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetWordLength(), Cy_USIC_CH_EnableFrameLengthControl() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetFrameLength(Cy_USIC_CH_t *const channel, const uint8_t frame_length)
{
 ...
 * @param channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @param event Bit mask of the channel events to be enabled. Use @ref Cy_USIC_CH_EVENT_t for the bit masks. \n
 * 				\b Range: @ref CY_USIC_CH_EVENT_RECEIVE_START, @ref CY_USIC_CH_EVENT_DATA_LOST etc. Multiple events
 ...
 * Cy_USIC_CH_EVENT_t enumerates multiple protocol event bitmasks. These enumerations can be used as input to the API.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableEvent(), Cy_USIC_CH_SetInterruptNodePointer() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableEvent(Cy_USIC_CH_t *const channel, const uint32_t event)
{
  channel->CCR |= event;
}
 ...
 * @param channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				  \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @param event Bit mask of the channel events to be disabled. Use @ref Cy_USIC_CH_EVENT_t for the bit masks. \n
 * 				\b Range: @ref CY_USIC_CH_EVENT_RECEIVE_START, @ref CY_USIC_CH_EVENT_DATA_LOST etc. Multiple events
 * 				can be combined using \a OR operation.
 * @return None
 *
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableEvent(), Cy_USIC_CH_SetInterruptNodePointer() \n\n\n
*/
__STATIC_INLINE void Cy_USIC_CH_DisableEvent(Cy_USIC_CH_t *const channel, const uint32_t event)
{
 ...
 * 						  \b Range: @ref CY_USIC_CH_INTERRUPT_NODE_POINTER_TRANSMIT_SHIFT,
 * 						  			@ref CY_USIC_CH_INTERRUPT_NODE_POINTER_TRANSMIT_BUFFER etc.
 ...
 * @param  channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @return Stataus @ref CY_USIC_CH_TBUF_STATUS_IDLE if transmit buffer is free,
 *                 @ref CY_USIC_CH_TBUF_STATUS_BUSY if transmit buffer is busy.
 *
 * \par<b>Description</b><br>
 ...
 * status is @ref CY_USIC_CH_TBUF_STATUS_IDLE.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetDataOutputMode() \n\n\n
 */
__STATIC_INLINE Cy_USIC_CH_TBUF_STATUS_t Cy_USIC_CH_GetTransmitBufferStatus(Cy_USIC_CH_t *const channel)
{
  return (Cy_USIC_CH_TBUF_STATUS_t)(channel->TCSR & USIC_CH_TCSR_TDV_Msk);
}
 ...
 * 		   \b Range: @ref CY_USIC_CH_RBUF_STATUS_DATA_VALID0, @ref CY_USIC_CH_RBUF_STATUS_DATA_VALID1.
 *
 * \par<b>Description</b><br>
 ...
 * If both bitmasks CY_USIC_CH_RBUF_STATUS_DATA_VALID0 and CY_USIC_CH_RBUF_STATUS_DATA_VALID1
 ...
 */
__STATIC_INLINE uint32_t Cy_USIC_CH_GetReceiveBufferStatus(Cy_USIC_CH_t *const channel)
{
 ...
 * 								\b Range: @ref CY_USIC_CH_START_TRANSMISION_DISABLED,
 * 								@ref CY_USIC_CH_START_TRANSMISION_ON_TDV, @ref CY_USIC_CH_START_TRANSMISION_ON_TDV_DX2S_0,
 * 								@ref CY_USIC_CH_START_TRANSMISION_ON_TDV_DX2S_1
 *
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_GetTransmitBufferStatus(), Cy_USIC_CH_SetDataOutputMode() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetStartTransmisionMode(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_START_TRANSMISION_MODE_t start_transmision_mode)
{
 ...
 * 			\b Range: @ref CY_USIC_CH_DATA_OUTPUT_MODE_NORMAL, @ref CY_USIC_CH_DATA_OUTPUT_MODE_INVERTED
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_SetStartTransmisionMode() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetDataOutputMode(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_DATA_OUTPUT_MODE_t data_output_mode)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableFrameLengthControl(), Cy_USIC_CH_TXFIFO_PutDataFLEMode() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableFrameLengthControl(Cy_USIC_CH_t *const channel)
{
 ...
 * Cy_USIC_CH_DisableFrameLengthControl(), Cy_USIC_CH_TXFIFO_PutDataFLEMode() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableWordLengthControl(Cy_USIC_CH_t *const channel)
{
  channel->TCSR = (uint32_t)(channel->TCSR & (~(USIC_CH_TCSR_WLEMD_Msk |
                             USIC_CH_TCSR_SELMD_Msk |
                             USIC_CH_TCSR_WAMD_Msk |
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableFrameLengthControl(), Cy_USIC_CH_SetFrameLength() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableFrameLengthControl(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableFrameLengthControl(), Cy_USIC_CH_SetWordLength() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableWordLengthControl(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableTBUFDataValidTrigger()\n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableTBUFDataValidTrigger(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableTBUFDataValidTrigger() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableTBUFDataValidTrigger(Cy_USIC_CH_t *const channel)
{
  channel->TCSR &= (uint32_t)~USIC_CH_TCSR_TDVTR_Msk;
}
 ...
 */
__STATIC_INLINE void Cy_USIC_CH_TriggerServiceRequest(Cy_USIC_CH_t *const channel, const uint32_t service_request_line)
{
 ...
 * Cy_USIC_CH_GetTransmitBufferStatus() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetTransmitBufferStatus(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_TBUF_STATUS_SET_t transmit_buffer_status)
{
 ...
 * Cy_USIC_CH_GetTransmitBufferStatus() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_InvalidateReadData(Cy_USIC_CH_t *const channel)
{
 ...
 * 			\b Range: @ref CY_USIC_CH_PASSIVE_DATA_LEVEL0, @ref CY_USIC_CH_PASSIVE_DATA_LEVEL1
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_GetTransmitBufferStatus(), Cy_USIC_CH_SetStartTransmisionMode() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetPassiveDataLevel(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_PASSIVE_DATA_LEVEL_t passive_level)
{
 ...
 * 		\b Range: @ref CY_USIC_CH_FIFO_DISABLED, @ref CY_USIC_CH_FIFO_SIZE_2WORDS.. @ref CY_USIC_CH_FIFO_SIZE_64WORDS
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_EnableEvent(), Cy_USIC_CH_TXFIFO_SetInterruptNodePointer() \n\n\n
 */
 ...
 * @return None
 *
 * \deprecated { Use Cy_USIC_CH_TXFIFO_SetTriggerLimit() }
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_SetSizeTriggerLimit() \n\n\n
 */
 ...
 * Cy_USIC_CH_RXFIFO_SetSizeTriggerLimit() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_SetTriggerLimit(Cy_USIC_CH_t *const channel,
    const uint32_t limit)
{
 ...
 * @param channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @param event Events to be enabled. Multiple events can be bitwise OR combined. @ref Cy_USIC_CH_TXFIFO_EVENT_CONF_t \n
 * @return None
 *
 * \par<b>Description</b><br>
 * Enables the interrupt events related to transmit FIFO. \n\n
 * Event bitmasks can be constructed using the enumeration @ref Cy_USIC_CH_TXFIFO_EVENT_CONF_t.
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_SetInterruptNodePointer() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_EnableEvent(Cy_USIC_CH_t *const channel, const uint32_t event)
{
  channel->TBCTR |= event;
}
 ...
 * @param channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @param event Events to be disabled. @ref Cy_USIC_CH_TXFIFO_EVENT_CONF_t \n
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 * flags from the status register using the API Cy_USIC_CH_TXFIFO_GetEvent().
 * Event bitmasks can be constructed using the enumeration @ref Cy_USIC_CH_TXFIFO_EVENT_CONF_t. For providing
 * multiple events, combine the events using bitwise OR operation.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_GetEvent(), Cy_USIC_CH_TXFIFO_EnableEvent() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_DisableEvent(Cy_USIC_CH_t *const channel, const uint32_t event)
{
 ...
 * 						  \b Range: @ref CY_USIC_CH_TXFIFO_INTERRUPT_NODE_POINTER_STANDARD,
 * 						  			@ref CY_USIC_CH_TXFIFO_INTERRUPT_NODE_POINTER_ALTERNATE
 ...
 * Cy_USIC_CH_TXFIFO_EnableEvent() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_PutData(Cy_USIC_CH_t *const channel, const uint16_t data)
{
  channel->IN[0] = data;
}
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableWordLengthControl() \n
 * Cy_USIC_CH_EnableFrameLengthControl() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_PutDataEx(Cy_USIC_CH_t *const channel, const uint16_t data, uint8_t loc)
{
  channel->IN[loc] = data;
}
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_PutDataEx() \n
 * Cy_USIC_CH_EnableFrameLengthControl() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_PutDataFLEMode(Cy_USIC_CH_t *const channel,
    const uint16_t data,
 ...
 * Cy_USIC_CH_EnableFrameLengthControl() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_PutDataHPCMode(Cy_USIC_CH_t *const channel,
    const uint16_t data,
    const uint32_t frame_length)
{
  channel->IN[frame_length] = data;
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_GetLevel() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_Flush(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_IsEmpty(), Cy_USIC_CH_TXFIFO_Flush() \n\n\n
 */
__STATIC_INLINE bool Cy_USIC_CH_TXFIFO_IsFull(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_Flush(), Cy_USIC_CH_TXFIFO_PutData() \n\n\n
 */
__STATIC_INLINE bool Cy_USIC_CH_TXFIFO_IsEmpty(Cy_USIC_CH_t *const channel)
{
 ...
 * Cy_USIC_CH_TXFIFO_Flush(), Cy_USIC_CH_TXFIFO_PutData() \n\n\n
 */
__STATIC_INLINE uint32_t Cy_USIC_CH_TXFIFO_GetLevel(Cy_USIC_CH_t *const channel)
{
 ...
 * @param channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @return Status of standard transmit and transmit buffer error events. @ref Cy_USIC_CH_TXFIFO_EVENT_t \n
 *
 * \par<b>Description</b><br>
 ...
 * User can make use of the @ref Cy_USIC_CH_TXFIFO_EVENT_t enumeration for checking the status of return value.
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_ClearEvent() \n\n\n
 */
__STATIC_INLINE uint32_t Cy_USIC_CH_TXFIFO_GetEvent(Cy_USIC_CH_t *const channel)
{
 ...
 * 			     \b Range: @ref CY_USIC_CH_TXFIFO_EVENT_STANDARD, @ref CY_USIC_CH_TXFIFO_EVENT_ERROR.
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 * CY_USIC_CH_TXFIFO_EVENT enumeration can be used as input. Multiple events
 * can be cleared by providing a mask value obtained by bitwise OR operation of
 * multiple event enumerations.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_GetEvent() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_TXFIFO_ClearEvent(Cy_USIC_CH_t *const channel,
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_EnableEvent(), Cy_USIC_CH_RXFIFO_SetInterruptNodePointer() \n\n\n
*/
 ...
 * @return None
 *
 * \deprecated { Use Cy_USIC_CH_RXFIFO_SetTriggerLimit() }
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_SetSizeTriggerLimit()\ n\n\n
 */
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_TXFIFO_SetSizeTriggerLimit() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_RXFIFO_SetTriggerLimit(Cy_USIC_CH_t *const channel,
    const uint32_t limit)
{
 ...
 * @param channel Pointer to USIC channel handler of type @ref Cy_USIC_CH_t \n
 * 				   \b Range: @ref CY_USIC0_CH0, @ref CY_USIC0_CH1 to @ref CY_USIC2_CH1 based on device support.
 * @param event Events to be enabled. Multiple events can be bitwise OR combined. @ref Cy_USIC_CH_RXFIFO_EVENT_CONF_t\n
 * @return None
 *
 * \par<b>Description</b><br>
 * Enables the interrupt events related to transmit FIFO. \n\n
 * Event bitmasks can be constructed using the enumeration @ref Cy_USIC_CH_RXFIFO_EVENT_CONF_t.
 * Multiple events can be enabled by providing multiple events in a single call. For providing
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_SetInterruptNodePointer() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_RXFIFO_EnableEvent(Cy_USIC_CH_t *const channel, const uint32_t event)
{
  channel->RBCTR |= event;
}
 ...
 * 			\b Range: @ref CY_USIC_CH_RXFIFO_EVENT_CONF_STANDARD, @ref CY_USIC_CH_RXFIFO_EVENT_CONF_ERROR,
 * 			@ref CY_USIC_CH_RXFIFO_EVENT_CONF_ALTERNATE.
 * @return None
 *
 * \par<b>Description</b><br>
 * Disables the selected interrupt events related to receive FIFO. \n\n
 * By disabling the interrupt events, generation of interrupt is stopped. User can poll the event
 * flags from the status register using the API Cy_USIC_CH_RXFIFO_GetEvent().
 * Event bitmasks can be constructed using the enumeration \a CY_USIC_CH_RXFIFO_EVENT_CONF. For providing
 * multiple events, combine the events using bitwise OR operation.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_GetEvent(), Cy_USIC_CH_RXFIFO_EnableEvent() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_RXFIFO_DisableEvent(Cy_USIC_CH_t *const channel, const uint32_t event)
{
 ...
 * 					\b Range: @ref CY_USIC_CH_RXFIFO_INTERRUPT_NODE_POINTER_STANDARD,
 * 					@ref CY_USIC_CH_RXFIFO_INTERRUPT_NODE_POINTER_ALTERNATE
 * @param service_request The service request to be used for interrupt generation.\n
 * 					\b Range: 0 to 5.
 * @return None
 *
 ...
 * the API Cy_USIC_CH_RXFIFO_IsEmpty(). Receive FIFO error flag will be set if an attempt is made
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_ClearEvent() \n\n\n
 */
__STATIC_INLINE uint16_t Cy_USIC_CH_RXFIFO_GetData(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_GetLevel() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_RXFIFO_Flush(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_IsEmpty(), Cy_USIC_CH_RXFIFO_Flush() \n\n\n
 */
__STATIC_INLINE bool Cy_USIC_CH_RXFIFO_IsFull(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_Flush(), Cy_USIC_CH_RXFIFO_PutData() \n\n\n
 */
__STATIC_INLINE bool Cy_USIC_CH_RXFIFO_IsEmpty(Cy_USIC_CH_t *const channel)
{
 ...
 * Cy_USIC_CH_RXFIFO_Flush(), Cy_USIC_CH_RXFIFO_PutData() \n\n\n
 */
__STATIC_INLINE uint32_t Cy_USIC_CH_RXFIFO_GetLevel(Cy_USIC_CH_t *const channel)
{
 ...
 * 			\b Range: @ref CY_USIC_CH_RXFIFO_EVENT_STANDARD, @ref CY_USIC_CH_RXFIFO_EVENT_ERROR,
 * 					  @ref CY_USIC_CH_RXFIFO_EVENT_ALTERNATE.
 *
 * \par<b>Description</b><br>
 ...
 * User can make use of the CY_USIC_CH_RXFIFO_EVENT enumeration for checking the status of return value.
 * The status can be found by using the bitwise AND operation on the returned value with the enumerated value.<br>
 *
 * Note: Event status flags should be cleared by the user explicitly.
 *
 ...
 * Cy_USIC_CH_RXFIFO_ClearEvent()\n\n\n
 */
__STATIC_INLINE uint32_t Cy_USIC_CH_RXFIFO_GetEvent(Cy_USIC_CH_t *const channel)
{
 ...
 * USIC channel peripheral does not clear the event flags after they are read.
 * This API clears the events provided in the \a mask value.
 * CY_USIC_CH_RXFIFO_EVENT enumeration can be used as input. Multiple events
 * can be cleared by providing a mask value obtained by bitwise OR operation of
 * multiple event enumerations.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_RXFIFO_GetEvent() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_RXFIFO_ClearEvent(Cy_USIC_CH_t *const channel,
    const uint32_t event)
{
  channel->TRBSCR = event;
}
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_DisableTimeMeasurement() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_EnableTimeMeasurement(Cy_USIC_CH_t *const channel)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_CH_EnableTimeMeasurement() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_DisableTimeMeasurement(Cy_USIC_CH_t *const channel)
{
  channel->BRG &= (uint32_t)~USIC_CH_BRG_TMEN_Msk;
}
 ...
 * 					\b Range: @ref CY_USIC_CH_BRG_MASTER_CLOCK_PASSIVE_LEVEL_0, @ref CY_USIC_CH_BRG_MASTER_CLOCK_PASSIVE_LEVEL_1.
 * @return None
 *
 * \par<b>Description</b><br>
 * Sets the idle mode pin level for the master clock output. \n
 */
__STATIC_INLINE void Cy_USIC_CH_SetMclkOutputPassiveLevel(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_BRG_MASTER_CLOCK_PASSIVE_LEVEL_t passive_level)
{
 ...
 * 					\b Range: @ref CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_0_DELAY_DISABLED,
 * 							  @ref CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_0_DELAY_ENABLED,
 * 							  @ref CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_1_DELAY_DISABLED,
 *							  @ref CY_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_1_DELAY_ENABLED,
 * @param clock_output Shift clock source selection. \n
 * 					\b Range: Use @ref CY_USIC_CH_BRG_SHIFT_CLOCK_OUTPUT_SCLK,
 * 								  @ref CY_USIC_CH_BRG_SHIFT_CLOCK_OUTPUT_DX1
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 * @ref Cy_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_t.
 ...
 *
 */
__STATIC_INLINE void Cy_USIC_CH_ConfigureShiftClockOutput(Cy_USIC_CH_t *const channel,
    const Cy_USIC_CH_BRG_SHIFT_CLOCK_PASSIVE_LEVEL_t passive_level,
    const Cy_USIC_CH_BRG_SHIFT_CLOCK_OUTPUT_t clock_output)
{
 ...
 * 				\b Range: @ref CY_USIC_CH_OPERATING_MODE_IDLE, @ref CY_USIC_CH_OPERATING_MODE_SPI,
 * 						  @ref CY_USIC_CH_OPERATING_MODE_UART, @ref CY_USIC_CH_OPERATING_MODE_I2S,
 * 						  @ref CY_USIC_CH_OPERATING_MODE_I2C.
 * @return None
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_USIC_Enable(), Cy_USIC_CH_Enable() \n\n\n
 */
__STATIC_INLINE void Cy_USIC_CH_SetMode(Cy_USIC_CH_t *const channel, const Cy_USIC_CH_OPERATING_MODE_t mode)
{
