...
/**
 * @addtogroup POSIF
 * @brief Position Interface Unit (POSIF) driver for the PSC1M microcontroller family <br>
 *
 ...
 * -#  Configuration structure Cy_POSIF_CONFIG_t and initialization function Cy_POSIF_Init() to configure global settings
 * -# Allows to change the operating mode using Cy_POSIF_SetMode()
 * -# Allows the selection of one of the four inputs (A, B, C or D) using Cy_POSIF_SelectInputSource(). In hall sensor control, inputs are
 * hall0, hall1 and hall2 signals. For quadrature decoder mode, inputs are phase A, phase B and index signals.
 * -#  Hall Sensor Control (APIs prefixed with CY_POSIF_HSC_) <br>
 * 	-  Configuration structure Cy_POSIF_HSC_CONFIG_t and initialization function Cy_POSIF_HSC_Init()
 * 	-  Update current and expected hall pattern in shadow register using Cy_POSIF_HSC_SetHallPatterns()
 * 	- Allows immediate shadow transfer using Cy_POSIF_HSC_UpdateHallPattern()
 * -#  Quadrature Decoder (APIs prefixed with CY_POSIF_QD_) <br>
 * 	-  Configuration structure Cy_POSIF_QD_CONFIG_t and initialization function Cy_POSIF_QD_Init()
 * 	-  Get direction of rotation using Cy_POSIF_QD_GetDirection()
 * -#  MultiChannel Mode (APIs prefixed with CY_POSIF_MCM_) <br>
 *	-  Configuration structure Cy_POSIF_MCM_CONFIG_t and initialization function Cy_POSIF_MCM_Init()
 *	-  Update multichannel pattern in shadow register using Cy_POSIF_MCM_SetMultiChannelPattern()
 *	-  Allows immediate shadow transfer using Cy_POSIF_MCM_UpdateMultiChannelPattern()
 ...
 * call both Cy_POSIF_HSC_Init() and Cy_POSIF_MCM_Init().
 * -# Allows to enable and disable interrupt sources and assign to service request node using Cy_POSIF_EnableEvent(), Cy_POSIF_DisableEvent() and Cy_POSIF_SetInterruptNode()
 *
...
#if defined(POSIF0) || defined(CY_DOXYGEN)
#include "cy_scu.h"
#include "cy_posif_map.h"

/*********************************************************************************************************************
 * MACROS
 ********************************************************************************************************************/
#define CY_POSIF_CHECK_MODULE_PTR(PTR)  ( ((PTR)== POSIF0) || ((PTR)== POSIF1) ) /*< Check for valid module pointer */

/*********************************************************************************************************************
 * ENUMS
 ********************************************************************************************************************/
/**
 *  Defines the return status, to verify the POSIF related API calls. Use type @ref Cy_POSIF_STATUS_t for this enum.
 */
typedef enum CY_POSIF_STATUS
{
  CY_POSIF_STATUS_OK = 0U,     /**< API fulfills request */
  CY_POSIF_STATUS_ERROR        /**< API cannot fulfill request */
} Cy_POSIF_STATUS_t;

/**
 * Defines POSIF configurable modes.Use type @ref Cy_POSIF_MODE_t for this enum.
 * The members defines the function selector(FSEL) bitfields of \a PCONF register.
 */
typedef enum CY_POSIF_MODE
{
  CY_POSIF_MODE_HALL_SENSOR = 0U, /**< Hall sensor mode */
  CY_POSIF_MODE_QD,               /**< Quadrature Decoder mode */
  CY_POSIF_MODE_MCM,              /**< Standalone Multichannel mode */
  CY_POSIF_MODE_MCM_QD           /**< Quadrature Decoder + Standalone Multichannel mode */
} Cy_POSIF_MODE_t;

/**
 * Defines POSIF configurable input ports.Use type @ref Cy_POSIF_INPUT_PORT_t for this enum.
 ...
 */
typedef enum CY_POSIF_INPUT_PORT
{
  CY_POSIF_INPUT_PORT_A = 0U, /**< INPUT-A */
  CY_POSIF_INPUT_PORT_B,      /**< INPUT-B */
  CY_POSIF_INPUT_PORT_C,      /**< INPUT-C */
  CY_POSIF_INPUT_PORT_D,      /**< INPUT-D */
  CY_POSIF_INPUT_PORT_E,      /**< INPUT-E */
  CY_POSIF_INPUT_PORT_F,      /**< INPUT-F */
  CY_POSIF_INPUT_PORT_G,      /**< INPUT-G */
  CY_POSIF_INPUT_PORT_H       /**< INPUT-H */
} Cy_POSIF_INPUT_PORT_t;

/**
 *  Defines active level of an input signal.Use type @ref Cy_POSIF_INPUT_ACTIVE_LEVEL_t for this enum.
 */
typedef enum CY_POSIF_INPUT_ACTIVE_LEVEL
{
  CY_POSIF_INPUT_ACTIVE_LEVEL_HIGH  = 0U, /**< Input - Active High */
  CY_POSIF_INPUT_ACTIVE_LEVEL_LOW         /**< Input - Active Low */
} Cy_POSIF_INPUT_ACTIVE_LEVEL_t;
 ...
 * Use type @ref Cy_POSIF_FILTER_t for this enum.
 * The member defines the low pass filter configuration(LPC) bitfield of \a PCONF register.
 */
typedef enum CY_POSIF_FILTER
{
  CY_POSIF_FILTER_DISABLED     = 0U, /**< No filtering */
  CY_POSIF_FILTER_1_CLOCK_CYCLE,     /**< Filter of 1 Clock Cycle */
  CY_POSIF_FILTER_2_CLOCK_CYCLE,     /**< Filter of 2 Clock Cycles */
  CY_POSIF_FILTER_4_CLOCK_CYCLE,     /**< Filter of 4 Clock Cycles */
  CY_POSIF_FILTER_8_CLOCK_CYCLE,     /**< Filter of 8 Clock Cycles */
  CY_POSIF_FILTER_16_CLOCK_CYCLE,    /**< Filter of 16 Clock Cycles */
  CY_POSIF_FILTER_32_CLOCK_CYCLE,    /**< Filter of 32 Clock Cycles */
  CY_POSIF_FILTER_64_CLOCK_CYCLE     /**< Filter of 64 Clock Cycles */
} Cy_POSIF_FILTER_t;

/**
 * Defines POSIF events.Use type @ref Cy_POSIF_IRQ_EVENT_t for this enum.
 ...
 */
typedef enum CY_POSIF_IRQ_EVENT
{
  CY_POSIF_IRQ_EVENT_CHE                  = 0U, /**< Hall Mode : Correct Hall Event */
  CY_POSIF_IRQ_EVENT_WHE                  = 1U, /**< Hall Mode : Wrong Hall Event */
  CY_POSIF_IRQ_EVENT_HALL_INPUT           = 2U, /**< Hall Mode : Hall Input update */
  CY_POSIF_IRQ_EVENT_MCP_SHADOW_TRANSFER  = 4U, /**< Hall Mode + MCM Mode : MC Pattern shadow transfer */
  CY_POSIF_IRQ_EVENT_INDX                 = 8U, /**< Quadrature Mode : Index event detection */
  CY_POSIF_IRQ_EVENT_ERR                  = 9U, /**< Quadrature Mode : Quadrature Phase Error */
  CY_POSIF_IRQ_EVENT_CNT                  = 10U, /**< Quadrature Mode : Quadrature Clock event */
  CY_POSIF_IRQ_EVENT_DIR                  = 11U, /**< Quadrature Mode : Quadrature Direction change event */
  CY_POSIF_IRQ_EVENT_PCLK                 = 12U  /**< Quadrature Mode : Quadrature period clock generation event */
} Cy_POSIF_IRQ_EVENT_t;

/**
 * Defines POSIF service request lines.Use type @ref Cy_POSIF_SR_ID_t for this enum.
 * It used to connect POSIF event to required service request line.
 * in \a PFLGE register for interrupt generation.
 */
typedef enum CY_POSIF_SR_ID
{
  CY_POSIF_SR_ID_0 = 0U, /**< SR-0 */
  CY_POSIF_SR_ID_1      /**< SR-1 */
} Cy_POSIF_SR_ID_t;

/**
 * Defines position decoder mode selection.Use type @ref Cy_POSIF_QD_MODE_t for this enum.
 * The member defines configuration for the operation of the quadrature decoder mode.
 * It used to configure \a QDC register.
 */
typedef enum CY_POSIF_QD_MODE
{
  CY_POSIF_QD_MODE_QUADRATURE       = 0U, /**< Standard Quadrature Mode */
  CY_POSIF_QD_MODE_DIRECTION_COUNT       /**< Direction Count Mode */
} Cy_POSIF_QD_MODE_t;

/**
 * Defines motor rotation direction.Use type @ref Cy_POSIF_QD_DIR_t for this enum.
 * The member defines the direction in quadrature mode.
 */
typedef enum CY_POSIF_QD_DIR
{
  CY_POSIF_QD_DIR_COUNTERCLOCKWISE  = 0U, /**< Counter Clockwise */
  CY_POSIF_QD_DIR_CLOCKWISE              /**< Clockwise */
} Cy_POSIF_QD_DIR_t;

/**
 * Defines frequency of index signal generation.Use type @ref Cy_POSIF_QD_INDEX_GENERATION_t for this enum.
 * Member represents available configuration for index marker generation using \a ICM  bit field in \a QDC register.
 */
typedef enum CY_POSIF_QD_INDEX_GENERATION
{
  CY_POSIF_QD_INDEX_GENERATION_NEVER  = 0U, /**< Never generate the index marker signal */
  CY_POSIF_QD_INDEX_GENERATION_ONCE,       /**< Generate only once after the first revolution */
  CY_POSIF_QD_INDEX_GENERATION_ALWAYS      /**< Index marker generated upon every revolution */
} Cy_POSIF_QD_INDEX_GENERATION_t;

/**
 *  Defines trigger edge in hall sensor mode.Use type @ref Cy_POSIF_HSC_TRIGGER_EDGE_t for this enum.
 *  It can be used to configure \a PCONF register's \a SPES and \a MSES bit fields.
 */
typedef enum CY_POSIF_HSC_TRIGGER_EDGE
{
  CY_POSIF_HSC_TRIGGER_EDGE_RISING  = 0U, /**< Rising edge */
  CY_POSIF_HSC_TRIGGER_EDGE_FALLING      /**< Falling edge */
} Cy_POSIF_HSC_TRIGGER_EDGE_t;
...
/**
 *
 * Defines POSIF peripheral register structure.Use type @ref Cy_POSIF_t for this data structure.
 */
typedef POSIF_GLOBAL_TypeDef Cy_POSIF_t;

/**
 *  Defines POSIF quadrature decoder initialization data structure.
 *  Use type @ref Cy_POSIF_QD_CONFIG_t for this data structure.
 *  It used to configure Quadrature mode using \a QDC register.
 */
typedef struct CY_POSIF_QD_CONFIG
{
  Cy_POSIF_QD_MODE_t mode;      /**< Operational Mode of the quadrature encoder and decoder */
  union
  {
    struct
    {
      ...
      uint32_t : 1;
      uint32_t index: 2;        /**< Index signal generation control. Use @ref Cy_POSIF_QD_INDEX_GENERATION_t to configure this field.*/
      uint32_t : 26;
    };
    uint32_t qdc;
  };
} Cy_POSIF_QD_CONFIG_t;

/**
 * Defines POSIF hall sensor control initialization data structure.
 * Use type @ref Cy_POSIF_HSC_CONFIG_t for this data structure.
 * It used to initialize hall sensor mode configuration using \a PCONF register.
 */
typedef struct CY_POSIF_HSC_CONFIG
{
  union
  {
    struct
...
} Cy_POSIF_MCM_CONFIG_t;

/**
 *  Defines POSIF module initialization data structure.
 *  Use type @ref Cy_POSIF_CONFIG_t for this data structure.
 *  It is used to initialize POSIF module using \a PCONF register.
 */
typedef struct CY_POSIF_CONFIG
{
  union
  {
    struct
    {
      uint32_t mode: 2;    /**< POSIF Operational mode. Use @ref Cy_POSIF_MODE_t to configure */
      uint32_t : 6;
...
/**
 * @param peripheral Pointer to an instance of POSIF module of type @ref Cy_POSIF_t
 * @retval None
 *
 ...
 * If running then it will ungate the peripheral clock.
 *
 * \par<b>Note</b><br>
 * This is the first API which application must invoke to configure POSIF.
 * It is internally called by Cy_POSIF_Init().
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_Disable(),Cy_POSIF_Init() \n\n\n
 */
 ...
 * If running then in addition it will gate the peripheral clock.
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_Init(),Cy_POSIF_QD_Init(),Cy_POSIF_MCM_Init() \n\n\n
*/
 ...
 * @param config Pointer to hall sensor control initialization data of type @ref Cy_POSIF_HSC_CONFIG_t
 * @retval Cy_POSIF_STATUS_t  Returns @ref CY_POSIF_STATUS_OK if configured in Hall Sensor Mode
 *                             else return @ref CY_POSIF_STATUS_ERROR.
 *
 * \par<b>Description</b><br>
 ...
 *
 * \par<b>Note</b><br>
 * It is necessary to have called Cy_POSIF_Init first with Hall sensor mode before invocation of this API.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_Init() \n\n\n
 */
 ...
 * @retval Cy_POSIF_STATUS_t Returns quadrature mode initialization status of type @ref Cy_POSIF_STATUS_t
 *
 * \par<b>Description</b><br>
 * Initializes quadrature decoder control mode.\n
 * Configures \a PCONF register with quadrature mode using @ref Cy_POSIF_QD_MODE_t data structure.
 * Initializes \a QDC register with quadrature mode configuration using @ref Cy_POSIF_QD_CONFIG_t structure.
 *
 * \par<b>Note</b><br>
 * It is necessary to have called Cy_POSIF_Init first with Quadrature decoder mode before invocation of this API.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_Init() \n\n\n
 */
 ...
 * @param peripheral Pointer to an instance of POSIF module
 * @param config Pointer to quadrature decoder initialization data
 * @retval Cy_POSIF_STATUS_t Returns multi channel pattern initialization status of type @ref Cy_POSIF_STATUS_t
 *
 * \par<b>Description</b><br>
 * Initializes multi channel mode in Hall mode, standalone multi-channel mode and quadrature with multi-channel mode.\n
 * Configures \a PCONF register with multi channel mode using @ref Cy_POSIF_MCM_CONFIG_t data structure.
 *
 * \par<b>Note</b><br>
 * It is necessary to call Cy_POSIF_Init first before invocation of this API.
 * For CY_POSIF_MODE_HALL_SENSOR, it is necessary to have called Cy_POSIF_HSC_Init before invocation of this API.
 * For CY_POSIF_MODE_MCM_QD, it is necessary to have called Cy_POSIF_QD_Init before invocation of this API.
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_Init(),Cy_POSIF_HSC_Init(),Cy_POSIF_QD_Init() \n\n\n
 */
Cy_POSIF_STATUS_t Cy_POSIF_MCM_Init(Cy_POSIF_t *const peripheral, const Cy_POSIF_MCM_CONFIG_t *const config);

/**
 * @param peripheral Pointer to an instance of POSIF module
 * @param mode POSIF operating mode of type @ref Cy_POSIF_MODE_t
 * @retval None
 *
 * \par<b>Description</b><br>
 * Configures POSIF module for \a mode.\n
 * Configures \a PCONF register's a\ FSEL bitfield with \a mode.
 * Refer @ref Cy_POSIF_MODE_t for available options.
 *
 * \par<b>Note</b><br>
 ...
 * Cy_POSIF_Stop() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_SetMode(Cy_POSIF_t *const peripheral, const Cy_POSIF_MODE_t mode)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_Stop(),Cy_POSIF_IsRunning() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_Start(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_Start(),Cy_POSIF_IsRunning() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_Stop(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_Start(),Cy_POSIF_Stop() \n\n\n
 */
__STATIC_INLINE bool Cy_POSIF_IsRunning(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_GetCurrentPattern(),Cy_POSIF_HSC_GetExpectedPattern() \n\n\n
 */
__STATIC_INLINE uint8_t Cy_POSIF_HSC_GetLastSampledPattern(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_GetLastSampledPattern(),Cy_POSIF_HSC_GetExpectedPattern() \n\n\n
 */
__STATIC_INLINE uint8_t Cy_POSIF_HSC_GetCurrentPattern(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_GetLastSampledPattern(),Cy_POSIF_HSC_GetCurrentPattern() \n\n\n
 */
__STATIC_INLINE uint8_t Cy_POSIF_HSC_GetExpectedPattern(Cy_POSIF_t *const peripheral)
{
 ...
 * or software trigger through API @ref Cy_POSIF_HSC_UpdateHallPattern().
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_GetCurrentPattern(),Cy_POSIF_HSC_SetExpectedPattern() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_HSC_SetCurrentPattern(Cy_POSIF_t *const peripheral, const uint8_t pattern)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_GetExpectedPattern() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_HSC_SetExpectedPattern(Cy_POSIF_t *const peripheral, const uint8_t pattern)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_SetExpectedPattern(),Cy_POSIF_HSC_SetCurrentPattern() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_HSC_SetHallPatterns(Cy_POSIF_t *const peripheral, const uint8_t pattern_mask)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_HSC_SetHallPatterns() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_HSC_UpdateHallPattern(Cy_POSIF_t *const peripheral)
{
 ...
 * or software trigger through API @ref Cy_POSIF_MCM_UpdateMultiChannelPattern().
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_MCM_GetMultiChannelPattern() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_MCM_SetMultiChannelPattern(Cy_POSIF_t *const peripheral, const uint16_t pattern)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_MCM_SetMultiChannelPattern() \n\n\n
 */
__STATIC_INLINE uint16_t Cy_POSIF_MCM_GetMultiChannelPattern(Cy_POSIF_t *const peripheral)
{
 ...
 * Cy_POSIF_MCM_SetMultiChannelPattern() \n\n\n
 */
__STATIC_INLINE uint16_t Cy_POSIF_MCM_GetShadowMultiChannelPattern(Cy_POSIF_t *const peripheral)
{
 ...
 * Cy_POSIF_MCM_SetMultiChannelPattern() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_MCM_UpdateMultiChannelPattern(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_MCM_UpdateMultiChannelPattern() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_MCM_EnableMultiChannelPatternUpdate(Cy_POSIF_t *const peripheral)
{
...
/**
 * @param peripheral Pointer to an instance of POSIF module
 * @retval Cy_POSIF_QD_DIR_t Return direction of revolution of the motor of type @ref Cy_POSIF_QD_DIR_t
 *
 * \par<b>Description</b><br>
 ...
 *
 */
__STATIC_INLINE Cy_POSIF_QD_DIR_t Cy_POSIF_QD_GetDirection(Cy_POSIF_t *const peripheral)
{
  return ((Cy_POSIF_QD_DIR_t)((peripheral->QDC & POSIF_QDC_DVAL_Msk) >> POSIF_QDC_DVAL_Pos));
}
 ...
 *
 * \par<b>Related APIs:</b><BR>
 *  Cy_POSIF_QD_GetPreviousState() \n\n\n
 */
__STATIC_INLINE uint8_t Cy_POSIF_QD_GetCurrentState(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_QD_GetCurrentState() \n\n\n
 */
__STATIC_INLINE uint8_t Cy_POSIF_QD_GetPreviousState(Cy_POSIF_t *const peripheral)
{
 ...
 *
 */
__STATIC_INLINE uint8_t Cy_POSIF_QD_GetCurrentIndexValue(Cy_POSIF_t *const peripheral)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_DisableEvent() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_EnableEvent(Cy_POSIF_t *const peripheral, const Cy_POSIF_IRQ_EVENT_t event)
{
 ...
 *
 *  \par<b>Related APIs:</b><BR>
 *  Cy_POSIF_EnableEvent() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_DisableEvent(Cy_POSIF_t *const peripheral, const Cy_POSIF_IRQ_EVENT_t event)
{
  peripheral->PFLGE &= ~((uint32_t)1 << (uint8_t)event);
}
 ...
 *  Cy_POSIF_ClearEvent() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_SetEvent(Cy_POSIF_t *const peripheral, const Cy_POSIF_IRQ_EVENT_t event)
{
 ...
 * Cy_POSIF_SetEvent() \n\n\n
 */
__STATIC_INLINE void Cy_POSIF_ClearEvent(Cy_POSIF_t *const peripheral, const Cy_POSIF_IRQ_EVENT_t event)
{
 ...
 *
 * \par<b>Related APIs:</b><BR>
 * Cy_POSIF_SetEvent(),Cy_POSIF_ClearEvent() \n\n\n
 */
__STATIC_INLINE uint8_t Cy_POSIF_GetEventStatus(Cy_POSIF_t *const peripheral, const Cy_POSIF_IRQ_EVENT_t event)
{
...
/**
 * @param peripheral Pointer to an instance of POSIF module
 * @param event Event to be acknowledged of type @ref Cy_POSIF_IRQ_EVENT_t
 * @param sr Service request line of type @ref Cy_POSIF_SR_ID_t
 * @retval None
 *
 * \par<b>Description</b><br>
